...
class ForecastingGridSearchCV(BaseGridSearch):
    ...
    backend : {"dask", "dask_lazy", "loky", "multiprocessing", "threading","ray"}, by default "loky".
        ...
        - "dask_lazy": same as "dask", but returns delayed objects when
          ``materialize_dask_lazy=False``, allowing external orchestration of
          computation graphs across multiple forecasters
    ...
    materialize_dask_lazy : bool, optional (default=True)
        ...
        This allows users to construct larger computation graphs across multiple
        forecasters before materializing. Only has effect when ``backend="dask_lazy"``.
    ...
    cv_results_lazy_ : list of dask.delayed objects, optional
        ...
        and ``materialize_dask_lazy=False``. Allows building larger computation
        graphs across multiple forecasters before materializing. Only present
